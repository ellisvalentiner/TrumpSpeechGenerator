...
# callbacks
checkpoint = ModelCheckpoint('models/weights-{epoch:02d}-{loss:.4f}.hdf5', monitor='loss', verbose=1, save_best_only=True, mode='min')
history = History()
...
for iteration in range(1, 21):
    ...
    model.fit(X, y, batch_size=64, nb_epoch=5, callbacks=callbacks_list)
